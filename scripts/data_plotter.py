...
#plotting.
graph_fp = r"C:\\Users\\Eleanor.E.Watson\\OneDrive - Shell\\Examples\\Dirty_Up_Clean_Up\\DUCU-example\\ducu-example\\graphs\\matplotlib"
relevant_cols = ['Coolant Pressure Outlet PSI P_COOLOU', 'Intake Air Pressure KPAG P_INAIR','Intake Air Temp °C T_INAIR','Fuel Flow kg/hr FLOWFUEL', 'Engine speed RPM SPEED','Intake Humidity g/kg HUM75','Post Inter Cooler Air Temp °C T_CHGOUT', 'Engine Torque NM TORQUE_1','Exhaust Pressure after Turbo kpa P_EXHABS','Injector Pulse width mS OBD_INJ'] 
