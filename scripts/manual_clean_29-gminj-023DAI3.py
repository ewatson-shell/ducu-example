...
feature_columns = ['BSFC','Fuel Flow kg/hr FLOWFUEL']
...
for df in csv_list:
    ...
    filter_df.drop(filter_df[(filter_df['seconds'] > 4500) & (filter_df['seconds'] < 10800)].index, inplace=True)
    filter_df.drop(filter_df[(filter_df['seconds'] > 201600) & (filter_df['seconds'] < 205200)].index, inplace=True)
